...
public class TileEntityBlueberryBushRenderer extends TileEntitySpecialRenderer {

	// The model of your block
	private final BlueberryBushModel model;

	public TileEntityBlueberryBushRenderer() {
	...
	public void renderTileEntityAt(TileEntity te, double x, double y, double z,
		...
		ResourceLocation bushTexture = (new ResourceLocation(
				"projectfruit:textures/blocks/blueberrybush.png"));
