...
public class ItemBlueberry extends ItemFood{
     ...
     */
    public ItemBlueberry setPotionEffect(int par1, int par2, int par3, float par4)
    {
        this.potionId = par1;
     ...
     */
    public ItemBlueberry setAlwaysEdible()
    {
    ...
    {
         itemIcon = iconRegister.registerIcon( "projectfruit:blueberry");
    }
}
