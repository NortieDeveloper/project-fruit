...
public class ItemBlueberryAxe extends ItemTool{
    ...
    public ItemBlueberryAxe(ToolMaterial par2EnumToolMaterial)
    {
    ...
    {
        itemIcon = iconRegister.registerIcon("projectfruit:blueberryaxe");
    }
