...
public class ItemBlueberryHoe extends Item{

    protected ToolMaterial theToolMaterial;

    public ItemBlueberryHoe(ToolMaterial lemonstoneTool)
    {
        super();
    ...
    {
        itemIcon = iconRegister.registerIcon( "projectfruit:blueberryhoe");
    }
