...
public class ItemBlueberryShovel extends ItemTool{
    ...
    public ItemBlueberryShovel(ToolMaterial par2EnumToolMaterial)
    {
    ...
    {
        itemIcon = iconRegister.registerIcon("projectfruit:blueberryshovel");
    }
