...
public class ItemBlueberrySword extends ItemSword{

    private float weaponDamage;
    private final ToolMaterial toolMaterial;

    public ItemBlueberrySword(ToolMaterial par2EnumToolMaterial)
    {
    ...
    {
        itemIcon = iconRegister.registerIcon("projectfruit:blueberrysword");
    }
