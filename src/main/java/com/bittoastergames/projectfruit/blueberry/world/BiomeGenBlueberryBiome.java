...
public class BiomeGenBlueberryBiome extends BiomeGenBase{

    private static final Height biomeHeight = new Height(0.0F, 0.5F);

    public BiomeGenBlueberryBiome(int par1)
    {
        super(par1);
