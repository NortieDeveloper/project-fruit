...
public class BlockLemonilium extends Block {

	 public BlockLemonilium()
	    {
	        ...
	        if (!par1World.isRemote)
	        {
	            ...
	            else if (par1World.getBlockLightValue(par2, par3 + 1, par4) >= 9)
	            {
	                for (int l = 0; l < 4; ++l)
	                {
	                    ...
	                    {
	                        par1World.setBlock(i1, j1, k1, ProjectFruitRegistry.lemonilium);
	                    }
	                }
	            }
	        }
     ...
     {
             this.sides = par1IconRegister.registerIcon("projectfruit:lemoniliumside");
             this.bottom = par1IconRegister.registerIcon("projectfruit:lemoniliumbottom");
             this.top = par1IconRegister.registerIcon("projectfruit:lemoniliumtop");
     }
	 ...
	 public Block idDropped(int par1, Random random, int zero) {
	        return ProjectFruitRegistry.lemonilium;
	}
}
