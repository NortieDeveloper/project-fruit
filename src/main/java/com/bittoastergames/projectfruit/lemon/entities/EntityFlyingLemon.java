...
public class EntityFlyingLemon extends EntityFlying implements IMob
{
    ...
    public EntityFlyingLemon(World par1World)
    {
        super(par1World);
        ...
        if (this.targetedEntity != null && this.targetedEntity.getDistanceSqToEntity(this) < d4 * d4)
        {
            ...
            if (this.canEntityBeSeen(this.targetedEntity))
            {
                ...
                if (this.attackCounter == 20)
                {
                    ...
                    EntityFlyingLemonExplosiveLarge entityexplosivelemon = new EntityFlyingLemonExplosiveLarge(this.worldObj, this, d5, d6, d7);
                    entityexplosivelemon.field_92057_e = this.explosionStrength;
                    double d8 = 4.0D;
                    Vec3 vec3 = this.getLook(1.0F);
                    entityexplosivelemon.posX = this.posX + vec3.xCoord * d8;
                    entityexplosivelemon.posY = this.posY + (double)(this.height / 2.0F) + 0.5D;
                    entityexplosivelemon.posZ = this.posZ + vec3.zCoord * d8;
                    this.worldObj.spawnEntityInWorld(entityexplosivelemon);
    ...
    {
        return ProjectFruitRegistry.explosiveLemon;
    }
