...
public class EntityLemonArrow extends Entity implements IProjectile
{
    ...
    public EntityLemonArrow(World par1World)
    {
        super(par1World);
    ...
    public EntityLemonArrow(World par1World, double par2, double par4, double par6)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
        this.setSize(0.5F, 0.5F);
    ...
    public EntityLemonArrow(World par1World, EntityLivingBase par2EntityLivingBase, EntityLivingBase par3EntityLivingBase, float par4, float par5)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
    ...
    public EntityLemonArrow(World par1World, EntityLivingBase par2EntityLivingBase, float par3)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
        this.shootingEntity = par2EntityLivingBase;
        ...
        else
        {
            ...
            if (movingobjectposition != null)
            {
                if (movingobjectposition.entityHit != null)
                {
                    ...
                    {
                        damagesource = ProjectFruit.causeLemonArrowDamage(this, this);
                    }
                    else
                    {
                        damagesource = ProjectFruit.causeLemonArrowDamage(this, this.shootingEntity);
                    }
    ...
    private void explode()
    {
        ...
        if(ProjectFruitRegistry.useBigExplosion){
            float var2 = 2.5F;
