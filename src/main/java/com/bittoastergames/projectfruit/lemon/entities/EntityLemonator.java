...
public class EntityLemonator extends EntityMob
{
	
	public EntityLemonator(World par1World)
	{
		super(par1World);
	...
	protected void applyEntityAttributes()
    {
	  ...
	  public void writeEntityToNBT(NBTTagCompound nbttagcompound)
		...
		public EntityLemonator spawnBabyAnimal(EntityMob entityMob) {
			return new EntityLemonator(worldObj);
