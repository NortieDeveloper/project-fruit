...
public class EntityPoshLemonator extends EntityMob
{

    public EntityPoshLemonator(World par1World)
    {
        super(par1World);
    ...
    public EntityPoshLemonator spawnBabyAnimal(EntityMob entityMob) {
        return new EntityPoshLemonator(worldObj);
