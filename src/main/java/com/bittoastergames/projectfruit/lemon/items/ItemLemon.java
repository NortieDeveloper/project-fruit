...
public class ItemLemon extends ItemFood
{
     ...
     */
    public ItemLemon setPotionEffect(int par1, int par2, int par3, float par4)
    {
        this.potionId = par1;
     ...
     */
    public ItemLemon setAlwaysEdible()
    {
    ...
    {
        itemIcon = iconRegister.registerIcon("projectfruit:lemon");
    }
}
