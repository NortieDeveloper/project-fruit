...
public class ItemLemonAxe extends ItemTool
{
    ...
    public ItemLemonAxe(ToolMaterial par2EnumToolMaterial)
    {
    ...
    {
         itemIcon = iconRegister.registerIcon( "projectfruit:lemonaxe");
    }
