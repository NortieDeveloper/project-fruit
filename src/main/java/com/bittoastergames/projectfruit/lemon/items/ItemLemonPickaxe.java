...
public class ItemLemonPickaxe extends ItemTool
{
    ...
    public ItemLemonPickaxe(ToolMaterial par2EnumToolMaterial)
    {
    ...
    {
         itemIcon = iconRegister.registerIcon("projectfruit:lemonpickaxe");
    }
