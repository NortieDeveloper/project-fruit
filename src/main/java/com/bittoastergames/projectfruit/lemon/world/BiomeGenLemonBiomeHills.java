...
public class BiomeGenLemonBiomeHills extends BiomeGenBase {
	...
	public BiomeGenLemonBiomeHills(int par1)
    {
        ...
        this.spawnableCreatureList.add(new SpawnListEntry(EntityLemonCow.class, 18, 2 ,6));
