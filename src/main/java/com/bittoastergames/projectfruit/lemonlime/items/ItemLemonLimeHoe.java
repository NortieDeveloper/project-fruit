...
public class ItemLemonLimeHoe extends Item
{
    protected ToolMaterial theToolMaterial;

    public ItemLemonLimeHoe(ToolMaterial lemonstoneTool)
    {
        super();
    ...
    {
        itemIcon = iconRegister.registerIcon( "projectfruit:lemonlimehoe");
    }
