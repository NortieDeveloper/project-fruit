...
public class ItemLemonLimePickaxe extends ItemTool
{
    ...
    public ItemLemonLimePickaxe(ToolMaterial par2EnumToolMaterial)
    {
    ...
    {
        itemIcon = iconRegister.registerIcon("projectfruit:lemonlimepickaxe");
    }
