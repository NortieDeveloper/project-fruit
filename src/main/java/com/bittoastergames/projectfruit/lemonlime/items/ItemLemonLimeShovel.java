...
public class ItemLemonLimeShovel extends ItemTool
{
    ...
    public ItemLemonLimeShovel(ToolMaterial par2EnumToolMaterial)
    {
    ...
    {
        itemIcon = iconRegister.registerIcon("projectfruit:lemonlimeshovel");
    }
