...
public class ItemLemonLimeSword extends Item
{
    private float weaponDamage;
    private final ToolMaterial toolMaterial;

    public ItemLemonLimeSword(ToolMaterial par2EnumToolMaterial)
    {
        super();
    ...
    {
    	itemIcon = iconRegister.registerIcon( "projectfruit:lemonlimesword");
    }
