...
public class BlockLimeGrass extends Block {

	 public BlockLimeGrass()
	    {
	        ...
	        if (!par1World.isRemote)
	        {
	            ...
	            else if (par1World.getBlockLightValue(par2, par3 + 1, par4) >= 9)
	            {
	                for (int l = 0; l < 4; ++l)
	                {
	                    ...
	                    {
	                        par1World.setBlock(i1, j1, k1, ProjectFruitRegistry.limeGrass);
	                    }
	                }
	            }
	        }
     ...
     {
             this.sides = par1IconRegister.registerIcon("projectfruit:limegrassside");
             this.bottom = par1IconRegister.registerIcon("projectfruit:lemoniliumbottom");
             this.top = par1IconRegister.registerIcon("projectfruit:limegrasstop");
     }
	 ...
	 public Block idDropped(int par1, Random random, int zero) {
	        return ProjectFruitRegistry.limeGrass;
	}
}
