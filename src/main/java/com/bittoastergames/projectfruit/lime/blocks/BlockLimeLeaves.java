...
public class BlockLimeLeaves extends BlockLeavesBase implements IShearable
{
    int[] field_150128_a;
    ...
    public void dropBlockAsItemWithChance(World world, int par2, int par3, int par4, int par5, float par6, int par7)
    {
        if (!world.isRemote)
        {
            ...
            {
                this.dropBlockAsItem(world, par2, par3, par4, new ItemStack(ProjectFruitRegistry.limeSapling, 1, 0));
            }
    ...
    {
        fancyIcon = iconRegister.registerIcon("projectfruit:limeleavesfancy");
        blockIcon = iconRegister.registerIcon("projectfruit:limeleaves");
    }
}