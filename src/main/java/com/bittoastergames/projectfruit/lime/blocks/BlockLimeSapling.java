...
import com.bittoastergames.projectfruit.lime.world.WorldGenLimeTree;
...
public class BlockLimeSapling extends BlockBush implements IGrowable
{

    public BlockLimeSapling()
    {
        super();
        float f = 0.4F;
    ...
    {
        return par1 == ProjectFruitRegistry.limeGrass || par1 == Blocks.dirt || par1 == Blocks.farmland;
    }
    ...
    public void growTree(World p_149878_1_, int p_149878_2_, int p_149878_3_, int p_149878_4_, Random p_149878_5_)
    {
        ...
        Object object = p_149878_5_.nextInt(10) == 0 ? new WorldGenLimeTree(true) : new WorldGenLimeTree(true);
        int i1 = 0;
        int j1 = 0;
        boolean flag = false;
        ...
        switch (l)
        {
            ...
            case 1:
                ...
                for (i1 = 0; i1 >= -1; --i1)
                {
                    for (j1 = 0; j1 >= -1; --j1)
                    {
                        ...
                        {
                            object = new WorldGenLimeTree(false);
                            flag = true;
                            break label78;
                        }
                    }
                ...
                if (!flag)
                {
                    j1 = 0;
                    i1 = 0;
                    object = new WorldGenLimeTree(true);
                }
            ...
            case 3:
                ...
                if (!flag)
                {
                    j1 = 0;
                    i1 = 0;
                    object = new WorldGenLimeTree(true, 4 + p_149878_5_.nextInt(7), 3, 3, false);
                }
    ...
    {
        blockIcon = iconRegister.registerIcon("projectfruit:limetreesapling");
    }
