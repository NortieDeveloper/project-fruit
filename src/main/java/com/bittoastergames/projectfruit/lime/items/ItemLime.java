...
public class ItemLime extends ItemFood
{
    ...
    public ItemLime(int par1, int par2, float par3, boolean par4)
    {
    ...
    public ItemLime(int par1, int par2, boolean par3)
    {
     ...
     */
    public ItemLime setPotionEffect(int par1, int par2, int par3, float par4)
    {
        this.potionId = par1;
     ...
     */
    public ItemLime setAlwaysEdible()
    {
    ...
    {
         itemIcon = iconRegister.registerIcon("projectfruit:lime");
    }
}
