...
public class ItemLimePickaxe extends ItemTool{
    ...
    public ItemLimePickaxe(ToolMaterial par2EnumToolMaterial)
    {
    ...
    {
        itemIcon = iconRegister.registerIcon("projectfruit:limepickaxe");
    }
