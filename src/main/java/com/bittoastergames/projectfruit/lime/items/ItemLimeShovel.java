...
public class ItemLimeShovel extends ItemTool{
    ...
    public ItemLimeShovel(ToolMaterial par2EnumToolMaterial)
    {
    ...
    {
        itemIcon = iconRegister.registerIcon("projectfruit:limeshovel");
    }
