...
public class FruitDimensionTeleporter extends Teleporter {
    ...
    public FruitDimensionTeleporter(WorldServer par1WorldServer)
    {
            ...
            for (int l = -2; l <= 2; ++l)
            {
                for (int i1 = -2; i1 <= 2; ++i1)
                {
                    for (int j1 = -1; j1 < 3; ++j1)
                    {
                        ...
                        int i2 = k + i1 * b1 - l * b0;
                        boolean flag = j1 < 0;
                        this.worldServerInstance.setBlock(k1, l1, i2, flag ? ProjectFruitRegistry.lemonBrick : Blocks.air);
                    }
                }
            }
    ...
    public boolean placeInExistingPortal(Entity par1Entity, double par2, double par4, double par6, float par8)
    {
        ...
        else
        {
            for (k1 = l - short1; k1 <= l + short1; ++k1)
            {
                ...
                for (int l1 = i1 - short1; l1 <= i1 + short1; ++l1)
                {
                    ...
                    {
                        if (this.worldServerInstance.getBlock(k1, i2, l1) == ProjectFruitRegistry.fruitPortal)
                        {
                            while (this.worldServerInstance.getBlock(k1, i2 - 1, l1) == ProjectFruitRegistry.fruitPortal)
                            {
                                --i2;
                            }
        ...
        if (d3 >= 0.0D)
        {
            ...
            if (this.worldServerInstance.getBlock(i - 1, j, k) == ProjectFruitRegistry.fruitPortal)
            {
                j2 = 2;
            }
            ...
            if (this.worldServerInstance.getBlock(i, j, k - 1) == ProjectFruitRegistry.fruitPortal)
            {
                j2 = 3;
            }
            ...
            for (i3 = -1; i3 <= 1; ++i3)
            {
                for (j3 = 1; j3 < 3; ++j3)
                {
                    for (k3 = -1; k3 < 3; ++k3)
                    {
                        ...
                        j4 = k2 + (j3 - 1) * l2 - i3 * l5;
                        flag = k3 < 0;
                        this.worldServerInstance.setBlock(l3, i4, j4, flag ? ProjectFruitRegistry.lemonBrick : Blocks.air);
                    }
                }
            }
        }
        ...
        for (i3 = 0; i3 < 4; ++i3)
        {
            for (j3 = 0; j3 < 4; ++j3)
            {
                for (k3 = -1; k3 < 4; ++k3)
                {
                    ...
                    this.worldServerInstance.setBlock(l3, i4, j4, (Block)(flag ? ProjectFruitRegistry.lemonBrick : ProjectFruitRegistry.fruitPortal), 0, 2);
                }
            }
