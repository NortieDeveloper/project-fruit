...
public class BlockOrangeLeaves extends BlockLeavesBase implements IShearable
{
    ...
    public void dropBlockAsItemWithChance(World world, int par2, int par3, int par4, int par5, float par6, int par7)
    {
        if (!world.isRemote)
        {
            ...
            {
                this.dropBlockAsItem(world, par2, par3, par4, new ItemStack(ProjectFruitRegistry.orangeSapling, 1, 0));
            }
    ...
    {
        fancyIcon = iconRegister.registerIcon("projectfruit:orangeleavesfancy");
        blockIcon = iconRegister.registerIcon("projectfruit:orangeleaves");
    }
}
