...
import com.bittoastergames.projectfruit.orange.world.WorldGenOrangeTree;
...
public class BlockOrangeSapling extends BlockBush implements IGrowable
{

    public BlockOrangeSapling()
    {
        super();
        float f = 0.4F;
    ...
    {
        return par1 == ProjectFruitRegistry.orangeGrass || par1 == Blocks.dirt || par1 == Blocks.farmland;
    }
    ...
    public void growTree(World p_149878_1_, int p_149878_2_, int p_149878_3_, int p_149878_4_, Random p_149878_5_)
    {
        ...
        Object object = p_149878_5_.nextInt(10) == 0 ? new WorldGenOrangeTree(true) : new WorldGenOrangeTree(true);
        int i1 = 0;
        int j1 = 0;
        boolean flag = false;
        ...
        switch (l)
        {
            ...
            case 1:
                ...
                for (i1 = 0; i1 >= -1; --i1)
                {
                    for (j1 = 0; j1 >= -1; --j1)
                    {
                        ...
                        {
                            object = new WorldGenOrangeTree(false);
                            flag = true;
                            break label78;
                        }
                    }
            ...
            case 3:
                ...
                if (!flag)
                {
                    j1 = 0;
                    i1 = 0;
                    object = new WorldGenOrangeTree(true, 4 + p_149878_5_.nextInt(7), 3, 3, false);
                }
    ...
    {
        blockIcon = iconRegister.registerIcon("projectfruit:orangetreesapling");
    }
