...
public class BlockOrangeStone extends Block{

	public BlockOrangeStone() {
		super(Material.rock);
	...
	public Item getItemDropped(int par1, Random random, int zero) {
		return ProjectFruitRegistry.orangeStone;
	}

	@Override
	public void registerBlockIcons(IIconRegister iconRegister) {
		blockIcon = iconRegister.registerIcon("projectfruit:orangestoneblock");
	}
