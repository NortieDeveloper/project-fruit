...
public class ItemBucketOrangeJuice extends ItemFood
{
    ...
    public ItemBucketOrangeJuice(int par1, float par2, boolean par3)
    {
        super(par1, par2, par3);
        setMaxStackSize(1);
        this.itemUseDuration = 32;
        this.healAmount = par1;
        this.isWolfsFavoriteMeat = par3;
        this.saturationModifier = par2;
        this.setCreativeTab(ProjectFruitRegistry.tabFruit);
    }

    public ItemBucketOrangeJuice(int par1, boolean par2)
    {
        this(par1, 0.6F, par2);
        this.setCreativeTab(ProjectFruitRegistry.tabFruit);
    }
     ...
     */
    public ItemBucketOrangeJuice setPotionEffect(int par1, int par2, int par3, float par4)
    {
        this.potionId = par1;
     ...
     */
    public ItemBucketOrangeJuice setAlwaysEdible()
    {
    ...
    {
         itemIcon = iconRegister.registerIcon( "projectfruit:orangejuicebucket");
    }
}
