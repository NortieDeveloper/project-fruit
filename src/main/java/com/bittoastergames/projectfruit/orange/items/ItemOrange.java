...
public class ItemOrange extends ItemFood
{
    ...
    public ItemOrange(int par1, int par2, float par3, boolean par4)
    {
        super(par1, par2, par4);
        this.itemUseDuration = 46;
    ...
    public ItemOrange(int par1, int par2, boolean par3)
    {
     ...
     */
    public ItemOrange setPotionEffect(int par1, int par2, int par3, float par4)
    {
        this.potionId = par1;
     ...
     */
    public ItemOrange setAlwaysEdible()
    {
    ...
    {
         itemIcon = iconRegister.registerIcon( "projectfruit:orange");
    }
}
