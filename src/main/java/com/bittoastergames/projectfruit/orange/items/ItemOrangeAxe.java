...
public class ItemOrangeAxe extends ItemTool{
    ...
    public ItemOrangeAxe(ToolMaterial par2EnumToolMaterial)
    {
    ...
    {
        itemIcon = iconRegister.registerIcon("projectfruit:orangeaxe");
    }
