...
public class ItemOrangePickaxe extends ItemTool{
    ...
    public ItemOrangePickaxe(ToolMaterial par2EnumToolMaterial)
    {
    ...
    {
        itemIcon = iconRegister.registerIcon("projectfruit:orangepickaxe");
    }
