...
public class ItemOrangeShovel extends ItemTool{
    ...
    public ItemOrangeShovel(ToolMaterial par2EnumToolMaterial)
    {
    ...
    {
        itemIcon = iconRegister.registerIcon("projectfruit:orangeshovel");
    }
